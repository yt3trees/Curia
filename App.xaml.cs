...
public partial class App : WpfApplication
{
    ...
    private static void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<AgentToolUsageLogService>();
        services.AddSingleton<TaskCompletionUndoStore>();
        ...
        services.AddSingleton<ICuriaAgentTool, GetProjectContextTool>();
        ...
        services.AddSingleton<ICuriaAgentTool, UndoTaskCompletionTool>();
